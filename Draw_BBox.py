...
train_img_path = r'/home/adlytic/datasets/Train_Data/images/' # Path for all training images
train_label_path = r'/home/adlytic/datasets/Train_Data/labels/' # Path for all training labels (annotations)
img_save_path = r'/home/adlytic/datasets/Train_Data/bbox_images/' # Path for saving the drawn BBox
